...
$(function () {
    $("#addMember").click(function () {
        ...
        focusCleanup: !0,
        rules: {
            "leaderInfos[0].name": {required: !1, specialchar: !0, checkNum: !0, minlength: 2, maxlenStr: 20},
            "leaderInfos[0].position": {required: !1, specialchar: !0, checkNum: !0, maxlenStr: 60},
            "leaderInfos[0].weibo": {required: !1, checkUrlNot: !0, maxlength: 120},
            "leaderInfos[0].remark": {required: !1, checkNum: !0, minlength: 10, maxlength: 500},
            "leaderInfos[1].name": {required: !1, specialchar: !0, checkNum: !0, minlength: 2, maxlenStr: 20},
            "leaderInfos[1].position": {required: !1, specialchar: !0, checkNum: !0, maxlenStr: 60},
            "leaderInfos[1].weibo": {required: !1, checkUrl: !0, maxlength: 120},
            "leaderInfos[1].remark": {required: !1, checkNum: !0, minlength: 10, maxlength: 500},
            "leaderInfos[2].name": {required: !1, specialchar: !0, checkNum: !0, minlength: 2, maxlenStr: 20},
            "leaderInfos[2].position": {required: !1, specialchar: !0, checkNum: !0, maxlenStr: 60},
            "leaderInfos[2].weibo": {required: !1, checkUrlNot: !0, maxlength: 120},
            "leaderInfos[2].remark": {required: !1, checkNum: !0, minlength: 10, maxlength: 500}
        },
        messages: {
            "leaderInfos[0].name": {
            ...
            "leaderInfos[0].position": {specialchar: "请输入真实的当前职位", checkNum: "请输入真实的当前职位", maxlenStr: "请输入真实的当前职位"},
            "leaderInfos[0].weibo": {checkUrlNot: "请输入真实的新浪微博地址", maxlength: "请输入120字符以内的网址"},
            ...
            "leaderInfos[1].position": {specialchar: "请输入真实的当前职位", checkNum: "请输入真实的当前职位", maxlenStr: "请输入真实的当前职位"},
            "leaderInfos[1].weibo": {checkUrlNot: "请输入真实的新浪微博地址", maxlength: "请输入120字符以内的网址"},
            ...
            "leaderInfos[2].position": {specialchar: "请输入真实的当前职位", checkNum: "请输入真实的当前职位", maxlenStr: "请输入真实的当前职位"},
            "leaderInfos[2].weibo": {checkUrlNot: "请输入真实的新浪微博地址", maxlength: "请输入120字符以内的网址"},
        ...
        submitHandler: function (a) {
            var b = $(a).find('input[type="text"]'), c = $(a).find("textarea");
            b.each(function () {
