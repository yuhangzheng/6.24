...
<head>
    ...
    <script src="/js/comlogin.js"></script>
    <script>
        function changeImg() {
...
<div id = "register">
    <div id = "register_left">
        <div class="register_left_r1">
            <a href="${pageContext.request.contextPath}/jobcenter/login.jsp">企业登录</a>
        </div>

        <div class="register_left_r2">
            <form>
                <span class="loginMessage" id="loginMsg"></span>
                <input type="text" placeholder="请输入邮箱"class="loginInfo" id="loginTelAndEmail" name = "stuPhoneEmail" onblur="loginTelAndPwd()"/>
    ...
    <div id = "register_right">
        <div class="register_right_r1">
            <span>没有账号? 直接 <a href="${pageContext.request.contextPath}/jobcenter/comRegister.jsp">注册</a></span>
        </div>
