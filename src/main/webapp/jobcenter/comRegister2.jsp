...
<head>
    ...
    <html xmlns:wb="http://open.weibo.com/wb"><head>
        ...
        <title>基本信息-招聘服务-就业服务中心-最专业的互联网招聘平台</title>
...
<script>
    ...
    function saveAndNext() {
         ...
         var url_saveAndNext = '${pageContext.request.contextPath}/jobcenter/tag.jsp';
   ...
   function nextIndex () {
       if (xhr.readyState == 4 && xhr.status == 200) {
           ...
           if (row != 0) {
               window.location.href="${pageContext.request.contextPath}/jobcenter/tag.jsp"
           }
       }
   }
