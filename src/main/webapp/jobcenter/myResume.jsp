	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a href="${pageContext.request.contextPath}/jobcenter/companyList.jsp">公司</a></li>
    			<li><a target="_blank" href="${pageContext.request.contextPath}/jobcenter/personCenter.jsp">个人中心</a></li>
            	...
            	<dt>
            		...
            		<i></i>
								...
								<dd><a href="${pageContext.request.contextPath}/jobcenter/personCenter.jsp">帐号设置</a></dd>
