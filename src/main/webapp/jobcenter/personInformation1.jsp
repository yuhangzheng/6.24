...
line-height: 57px;font-size: 20px;color: #999;display: inline-block; ">
        ...
        <div style="position: relative;bottom: 40px;left: 550px;">
            ...
            <a href="${pageContext.request.contextPath}/jobcenter/index.jsp"><label style="padding: 30px;">首页</label></a>
            <a href="${pageContext.request.contextPath}/student/isLogin" ><label style="padding: 30px;">我的简历</label></a>
            <a href="${pageContext.request.contextPath}/jobcenter/companyList.jsp" rel="nofollow"><label style="padding: 30px;">公司</label></a>
    ...
    <div style="position:relative;right: 110px;">
            ...
            <div class="setp">
                <div class="mail">
                    <div class="e">
                        <p><i></i><em></em></p>
                        <b>1</b>
                        <span style="color: #647dfa;font-weight: 900;">基本信息</span>
                    </div>
                    <div class="e">
                        <p><i></i><em></em></p>
                        <b>2</b>
        ...
        <div style="padding-right: 400px;">
            <div id="one" style="width:670px;height:570px;font-size: 16px;background-color: #fff;margin-right:10px;padding-left: 50px;padding-top: 50px;">
                <h3 style="font-size: 20px;color: #647dfa">个人信息:</h3><br>

                <form action="${pageContext.request.contextPath}/information/insert1" method="post">

                    姓名： <input type="text" id="textName" style="border: 1px solid grey;"name="stuName" onblur="checkname();"><span id="spanName"></span><br><br><br>
                    性别：<input type="radio" name="stuGender"value="1">男 <input type="radio" name="stuGender" value="0">女<br><br><br>
                    户籍： <select name="stuHometownProvince" >
                    <option>北京</option><option>上海</option><option>天津</option><option>重庆</option><option>广东</option><option>内蒙古</option><option>黑龙江</option><option>安徽</option><option>辽宁</option><option>江苏</option><option>浙江</option>
                </select><br><br><br>
                    现居地： <input type="textarea" style="border: 1px solid grey;"name="stuAddrProvince" ><br><br><br>
                    电子邮箱： <input type="email" id="email" style="border: 1px solid grey;"name="stuEmail" onblur="checkemail()"><span id="spanEmail"></span><br><br><br>
                    学校名称： <input type="text" id="name" style="border: 1px solid grey;"name="stuSchool"  onblur="checkschoolname();"><span id="span1"></span><br><br><br>
                    学历/学位：<input type="text" id="school"style="border: 1px solid grey;" name="stuDegree" onblur="checkschool();"><span id="span2"></span><br><br><br>
                    是否统招： <select name="stuGen">
                    ...
                    <button id="button" type="submit" onclick="pointchicken();" style="font-size: 18px;width:250px;border-color:#647dfa;background-color: #647dfa;height: 46px;">保存并继续填写项目经验</button>
                </form>
                    ...
                    <div class="module">
                        <ul class="module-list">
                            <li class="module1">
                                ...
                                <p class="name" style="color: #647dfa;font-weight:900;">个人信息</p>
                                <div class="line"></div>
                            ...
                            <li class="module3">
                                ...
                                <p class="name" style="color: #647dfa;font-weight:900;">教育经历</p>
                                <div class="line"></div>
                                <div class="complete" style="display: block;"></div>
                            </li>
