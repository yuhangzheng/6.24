<%@ page import="com.jobcenter.entity.User" %>
<%@ page import="com.jobcenter.util.DataBaseGet" %>
            ...
            <div>
                ...
                <!--未登陆-->
                 <ul class="nav navbar-nav navbar-right">
                       <li>
                           <p class="navbar-text"><a style="color:white" href="${pageContext.request.contextPath}/jobcenter/login.jsp">登录</a></p>
                       </li>
                       <li>
                               <p class="navbar-text"><a style="color:white" href="${pageContext.request.contextPath}/jobcenter/register.jsp">注册</a></p>
                       </li>
                 </ul>
                </c:if>
            <c:if test="${!empty userId}">
