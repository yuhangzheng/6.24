...
<div class="as-mainwrapper">
            ...
            <div id="header">
                <div class="wrapper">
                    ...
                    <ul class="reset" id="navheader">
                        ...
                        <li><a href="${pageContext.request.contextPath}/jobcenter/companyList.jsp"
                    ...
                    <ul class="loginTop">
                        <c:choose>
                            <c:when test="${empty stuId  && empty comId && empty adminId}">
                                <li><a href="${pageContext.request.contextPath}/jobcenter/adminLogin.jsp"
                                       rel="nofollow">管理员登录</a></li>
                                <li>|</li>
                                <li><a href="${pageContext.request.contextPath}/jobcenter/login.jsp"
                                       rel="nofollow">学生登录</a></li>
                                <li>|</li>
                                <li><a href="${pageContext.request.contextPath}/jobcenter/comLogin.jsp"
                            ...
                            <c:when test="${!empty comId || !empty comPhoneMail}">
                                <li><a href="${pageContext.request.contextPath}/jobcenter/pending.jsp">欢迎${comPhoneMail}</a>
                                </li>
                                <li>|</li>
                            ...
                            <c:when test="${!empty adminId && !empty adminName}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/jobcenter/check.jsp">欢迎管理员${adminName}</a>
                                </li>
                                <li>|</li>
    ...
    <script>
        ...
        function returnToList() {
            window.location.href = "${pageContext.request.contextPath}/jobcenter/list.jsp";
        }
