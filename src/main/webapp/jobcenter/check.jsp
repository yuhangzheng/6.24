<%@ page import="com.jobcenter.entity.AdminGetCom" %>
<%@ page import="java.util.List" %>
<%@ page import="com.jobcenter.entity.AdminGetStu" %>
    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul class="reset" id="navheader">
                <li class="current"><a href="${pageContext.request.contextPath}/jobcenter/index.jsp">首页</a></li>

                <li><a href="${pageContext.request.contextPath}/jobcenter/companyList.jsp" target="_blank">公司列表</a>
                </li>
            ...
            <ul class="loginTop">
                <c:choose>
                    <c:when test="${empty stuId  && empty comId && empty adminId}">
                        <li><a href="${pageContext.request.contextPath}/jobcenter/comLogin.jsp" rel="nofollow">企业入口</a>
                        </li>
                        <li>|</li>
                        <li><a href="${pageContext.request.contextPath}/jobcenter/login.jsp"
                               rel="nofollow">学生入口</a></li>
                        <li>|</li>
                        <li><a href="${pageContext.request.contextPath}/jobcenter/adminLogin.jsp" rel="nofollow">管理员入口</a>
                        </li>
                    </c:when>
...
<div id="footer">
    <div class="wrapper">
        ...
        <div class="copyright">&copy;2018-2019 jobcenter <a target="_blank"
