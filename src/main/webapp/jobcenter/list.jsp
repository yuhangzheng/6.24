...
<head>
    ...
    <title>职位搜索-就业服务中心-最专业的互联网招聘平台</title>
    ...
    <div id="header">
        <div class="wrapper">
            <a href="index.html" class="logo">
                <img src="${pageContext.request.contextPath}/images/logo.png" width="229" height="43" alt="就业服务中心-专注互联网招聘" />
            </a>
            <ul class="reset" id="navheader">
                ...
                <li ><a href="${pageContext.request.contextPath}/jobcenter/companyList.jsp" target="_blank">公司</a></li>
...
<div id="footer">
    <div class="wrapper">
        ...
        <div class="copyright">&copy;2018-2019 jobcenter <a target="_blank" href="http://www.miitbeian.gov.cn/state/outPortal/loginPortal.action">京ICP备18023790号-2</a></div>
    </div>
</div>
