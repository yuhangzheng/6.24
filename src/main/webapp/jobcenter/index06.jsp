...
<div id="body">
    <div id="header">
        <div class="wrapper">
            ...
            <ul id="navheader" class="reset">
                ...
                <li><a rel="nofollow" href="${pageContext.request.contextPath}/jobcenter/myhome2.jsp">企业中心</a></li>
            </ul>
    ...
    <div id="container">
        ...
        <div class="sidebar">
            <a class="btn_create" href="${pageContext.request.contextPath}/jobcenter/releaseJob.jsp">发布新职位</a>
            <dl class="company_center_aside">
                ...
                <dd class="btm">
                    <a href="${pageContext.request.contextPath}/jobcenter/pending.jsp">自动过滤简历</a>
                    <span></span>
                </dd>
            </dl>
            <dl class="company_center_aside">
                <dt>我发布的职位</dt>
                <dd>
                    <a href="${pageContext.request.contextPath}/jobcenter/positions.jsp">有效职位</a>
                </dd>
                <dd>
                    <a href="${pageContext.request.contextPath}/jobcenter/positions.jsp">已下线职位</a>
                </dd>
                <script >
            ...
            <dl class="company_center_content">
                ...
                <dd>
                    ...
                    <div class="publish_tip">
                        <h2>恭喜你，职位发布成功！</h2>
                        <a target="_blank" href="${pageContext.request.contextPath}/jobcenter/index.jsp">预览职位</a><br>
                        <a class="greylink" href="${pageContext.request.contextPath}/jobcenter/releaseJob.jsp">继续发布新职位</a><br>
                        <a class="greylink" href="${pageContext.request.contextPath}/jobcenter/myhome.jsp"> 进入我的公司主页</a><br>
