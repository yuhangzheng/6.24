...
<div id="body">
    ...
    <div id="container">
        ...
        <div class="sidebar">
            ...
            <dl class="company_center_aside">
                <dt>我收到的简历</dt>
                <dd>
                    <a href="${pageContext.request.contextPath}/jobcenter/pending.jsp">待查看简历</a>
                </dd>
                <dd>
                    <a href="${pageContext.request.contextPath}/jobcenter/pending.jsp">待处理简历</a>
                </dd>
                <dd>
                    <a href="${pageContext.request.contextPath}/jobcenter/pending.jsp">待定简历</a>
                </dd>
                <dd>
                    <a href="${pageContext.request.contextPath}/jobcenter/pending.jsp">已通知面试简历</a>
                </dd>
                <dd class="btm">
                    <a href="${pageContext.request.contextPath}/jobcenter/pending.jsp">不合适简历</a>
                </dd>
            </dl>
            <dl class="company_center_aside">
                <dt>我发布的职位</dt>
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <dd>
                    ...
                    <form action="${pageContext.request.contextPath}/releaseJob/insert" method="post" id="jobForm">
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td width="85">职位类别</td>
                                <td>
                                    <input type="hidden" id="positionType" value="" name="comReleaseJobType">
                            ...
                            <tr>
                                ...
                                <td>职位名称</td>
                                <td>
                                    <input type="text" placeholder="请输入职位名称，如：产品经理" value="" name="comReleaseJobName" id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>所属部门</td>
                                <td>
                                    <input type="text" placeholder="请输入所属部门" value="" name="comReleaseJobDepart" id="department">
                                </td>
                            </tr>
                            </tbody></table>
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td>
                                    <ul class="profile_radio clearfix reset">
                                        <li>
                                            全职<em></em>
                                            <input type="radio" name="comReleaseJobProp" value="全职">
                                        </li>
                                        <li>
                                            兼职<em></em>
                                            <input type="radio" name="comReleaseJobProp" value="兼职">
                                        </li>
                                        <li>
                                            实习<em></em>
                                            <input type="radio" name="comReleaseJobProp" value="实习">
                                        </li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="salary_range">
                                        <div>
                                            <input type="text" placeholder="最低月薪" value="" id="salaryMin" name="comReleaseJobSalaryLow">
                                            <span>k</span>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>工作城市</td>
                                <td>
                                    <input type="text" placeholder="请输入工作城市，如：北京"name="comReleaseJobCity">
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td width="85">工作经验</td>
                                <td>
                                    <input type="hidden" id="experience" value="" name="comReleaseJobExp">
                            ...
                            <tr>
                                ...
                                <!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
                                <td>
                                    <input type="hidden" id="education" value="" name="comReleaseJobRequir">
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td width="85">职位诱惑</td>
                                <td>
                                    <input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="" name="comReleaseJobTemp" class="input_520" id="positionAdvantage">
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                            ...
                            <tr>
                                ...
                                <td>工作地址</td>
                                <td>
                                    <input type="text" placeholder="请输入详细的工作地址" value="" name="comReleaseJobAddr" class="input_520" id="positionAddress">
                        ...
                        <table>
                            <tbody><tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <input type="hidden" value="admin@admin.com" id="receiveEmail" name="comReleaseJobEmail">
                                </td>
                            </tr>
                            <tr>
                                <td width="25"></td>
        ...
        <script src="/js/jobs.min.js" type="text/javascript"></script>
    ...
    <div id="footer">
        <div class="wrapper">
            ...
            <div class="copyright">©2018-2019 jobcenter <a href="#" target="_blank">京ICP备18023790号-2</a></div>
        </div>
    </div>
</div><!-- end #body -->
