...
<div id = "register">
    <div id = "register_left">
        <div class="register_left_r1">
            <a href="${pageContext.request.contextPath}/jobcenter/adminLogin.jsp">管理员登录</a>
        </div>

        <div class="register_left_r2">
            <form>
                <span class="loginMessage" id="loginMsg"></span>
                <input type="text" placeholder="请输入管理员用户名"class="loginInfo" id="loginName" name = "adminName" onblur="loginName()"/>
                <span class="loginMsg"></span>

                <input type="password" placeholder="请输入密码" class="loginInfo" id="loginPwd" name="adminPwd" onblur="loginPassword()" />
                ...
                <div class="remember">
                    ...
                    <div class="reb_pwd"><a href="${pageContext.request.contextPath}/jobcenter/getpass.jsp"><pre>忘记密码</pre></a></div>
                </div>
                <button type="button" class = "loginButton" onclick="adminLogin()"><span>登录</span></button>

            </form>
            <div class="register_right_r1">
                <span>没有账号? 直接 <a href="${pageContext.request.contextPath}/jobcenter/register.jsp">注册</a></span>
            </div>
        </div>
    </div>
