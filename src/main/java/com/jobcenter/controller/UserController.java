...
import com.jobcenter.entity.Topic;
import com.jobcenter.entity.User;
import com.jobcenter.service.impl.LoginLogServiceImpl;
import com.jobcenter.service.impl.TopicServiceImpl;
import com.jobcenter.service.impl.UserServiceImpl;
import com.jobcenter.util.ProduceMD5;
...
public class UserController {
    ...
    public ModelAndView updateAvatarDo(@RequestPart("avatar") MultipartFile avatarFile, HttpServletRequest request, HttpSession session){
        ...
        System.out.println( session.getServletContext().getRealPath("/jobcenter//style/images/avatar"));
        String absolutePath=session.getServletContext().getRealPath("/jobcenter//style/images/avatar")+"/"+newFileName;
        ...
        String relativePath="/images/avatar"+"/"+newFileName;  //头像上传后保存到tomcat/root底下
